...
if(!is.na(params$PERCMARGACRES)){
  paste0(
  "Quick Facts about your data:
  \begin{itemize}
  \item In 2022",params$PERCMARGACRES," \% of total acres were marginal (less than \$0 profit/acre).
  \end{itemize}"
  )
}
...
<!-- Doesn't work if no marginal acres (i.e. no economic data for 2022) -->
<!-- Quick Facts about your data: -->
<!-- \begin{itemize} -->
